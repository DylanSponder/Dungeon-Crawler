...
public enum EnemyCyclopsState implements State<EnemyCyclops> {
    ...
    WANDER() {
        ...
        @Override
        public void update(EnemyCyclops enemy) {
            enemy.alerted = false;
        }
        ...
        @Override
        public boolean onMessage(EnemyCyclops enemy, Telegram telegram) {
            return false;
        }
    },
    ...
    GO_TO_PLAYER() {
        ...
        @Override
        public void update(final EnemyCyclops enemy) {
        ...
        @Override
        public boolean onMessage(EnemyCyclops entity, Telegram telegram) {
            return false;
        }
    },
    ...
    DIE() {
        ...
        public void enter (EnemyCyclops enemy){
            ...
            Iterator<EnemyCyclops> enemyIt = enemyEyes.iterator();

            if (enemyIt.hasNext()) {
                enemyEyes.remove(enemy);
            }
