...
public class EnemyCrab extends Enemy {
    public StateMachine<EnemyCrab, EnemyCrabState> stateMachine;
    public int enemyID;
 ...
 */
    ...
    */
    ...
    public void throwBoneAtPlayer() {
       ...
       // Bone bone = new Bone(world, Crab.CrabBody, Crab.CrabBody.getPosition().x, Crab.CrabBody.getPosition().y, false, 0, true, angle);


    }

    public Wander<Vector2> wander(EnemyCrabBox2DSteeringEntity owner, float wanderOrientation) {
        ...
        //Ray<Vector2> ray = new Ray<>(enemyBody.getPosition(),player.playerBody.getPosition());
            ...
            world.rayCast((fixture, point, normal, fraction) -> {
                        ...
                        if (fixture.getBody().getType() == BodyDef.BodyType.StaticBody && fixture.getBody().getUserData() != "Crab" && fixture.getBody().getUserData() != "Fire"
                            ...
                            playerSighted = false;
                            this.getStateMachine().changeState(EnemyCrabState.WANDER);
    ...
    public StateMachine<EnemyCrab, EnemyCrabState> getStateMachine () {
        return stateMachine;
    }
}
