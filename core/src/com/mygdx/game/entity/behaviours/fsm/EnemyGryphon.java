...
import com.mygdx.game.entity.utils.EnemyGryphonBox2DSteeringEntity;
import com.mygdx.game.level.objects.DisplayText;

import static com.mygdx.game.DungeonCrawler.*;

public class EnemyGryphon extends Enemy {
    public StateMachine<EnemyGryphon, EnemyGryphonState> stateMachine;
    public int enemyID;
    public EnemyGryphonBox2DSteeringEntity enemyAI;
    ...
    public EnemyGryphon(World world, float x, float y) {
        ...
        this.enemyHitbox = bodyFactory.createEnemyGryphonHitbox(enemyBody, 5.95f);

        this.enemyDetectionRadius = bodyFactory.createEnemyDetectionRadius(enemyBody, 150f);
        ...
        this.enemyAI = new EnemyGryphonBox2DSteeringEntity(enemyBody, 10);
        //playerDetectionRay = new EnemyBox2DSteeringEntity(enemyBody,10);

        stateMachine = new DefaultStateMachine<EnemyGryphon, EnemyGryphonState>(this, EnemyGryphonState.WANDER);
        stateMachine.changeState(EnemyGryphonState.STOP);
        this.enemyBody.setUserData("Enemy");
        this.enemyHitbox.setUserData("EnemyGryphon");

        this.debug = false;

        this.swapFlyingDirection = true;
        this.flyingUp = true;
/*
 ...
 */
    ...
    */
    ...
    public void throwBoneAtPlayer() {
       ...
       // Bone bone = new Bone(world, Gryphon.GryphonBody, Gryphon.GryphonBody.getPosition().x, Gryphon.GryphonBody.getPosition().y, false, 0, true, angle);


    }

    public Wander<Vector2> wander(EnemyGryphonBox2DSteeringEntity owner, float wanderOrientation) {
        ...
        //Ray<Vector2> ray = new Ray<>(enemyBody.getPosition(),player.playerBody.getPosition());
            ...
            world.rayCast((fixture, point, normal, fraction) -> {
                        ...
                        if (fixture.getBody().getType() == BodyDef.BodyType.StaticBody && fixture.getBody().getUserData() != "Gryphon" && fixture.getBody().getUserData() != "Fire"
                            ...
                            playerSighted = false;
                            this.getStateMachine().changeState(EnemyGryphonState.WANDER);
