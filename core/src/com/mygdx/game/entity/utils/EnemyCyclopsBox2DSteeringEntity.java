...
public class EnemyCyclopsBox2DSteeringEntity implements Steerable<Vector2> {
    ...
    public EnemyCyclopsBox2DSteeringEntity(Body body, float boundingRadius){
        this.body = body;
        ...
        this.maxAngularAcceleration = 500;
