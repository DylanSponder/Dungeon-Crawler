...
public class EnemyGryphonBox2DSteeringEntity implements Steerable<Vector2> {
    ...
    public EnemyGryphonBox2DSteeringEntity(Body body, float boundingRadius){
        this.body = body;
        this.boundingRadius = boundingRadius;

        this.maxLinearSpeed = 0;
        this.maxLinearAcceleration = 200;//200
        this.maxAngularSpeed = 0;//200
        this.maxAngularAcceleration = 0;//400
