...
public class EnemySkullBox2DSteeringEntity implements Steerable<Vector2> {
    ...
    public EnemySkullBox2DSteeringEntity(Body body, float boundingRadius){
        this.body = body;
        this.boundingRadius = boundingRadius;

        this.maxLinearSpeed = 0;
        this.maxLinearAcceleration = 200;//200
        this.maxAngularSpeed = 1000;//200
        this.maxAngularAcceleration = 1000;//400
