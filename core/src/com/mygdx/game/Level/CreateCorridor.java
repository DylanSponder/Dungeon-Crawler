        ...
        if (upDown) {
            for(int i=0;i<4;i++) {
                ...
                if (i == 3) {
                    ...
                    if (rand == 2) {
                        Roof r = new Roof(world, ((doorX+3) * 16) + 12*16, (doorY * 16 + Gdx.graphics.getHeight() / 30 - 16) - i*16 - 16, upDown);
                        roofs.add(r);
                    }
                }
            }
                ...
                if (i == 1) {
                    for (int iTop = 0; iTop<4; iTop++) {
                        if (iTop == 0) {
                            ...
                            if (rand3 == 2) {
                                Roof r = new Roof(world, ((doorX+3) * 16) + 17*16, (doorY * 16 + Gdx.graphics.getHeight() / 30 - 16) - i*16 - 32, upDown);
                                roofs.add(r);
                            }
                            TiledMapTileLayer.Cell newTopCorridorWallCell;
