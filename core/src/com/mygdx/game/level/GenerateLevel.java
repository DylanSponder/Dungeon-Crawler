...
public class GenerateLevel {
    private List<List<String>> room, roomFile;
    ...
    public boolean attemptLevelGen(int level) {
        ...
        for (int i = 0; i < numRooms; i++) {
            ...
            */
            //
            System.out.println(path.get(roomsIndex - 1));
            if (!startingRoom && ((path.get(roomsIndex - 1) != 5) && (path.get(roomsIndex) != 5))) {
                String roomPath = System.getProperty("user.dir") + "\\" + "Rooms" + "\\" + path.get(roomsIndex-1) + path.get(roomsIndex) + "\\";

                File dir = new File(roomPath);

                File[] files = dir.listFiles();

                Random rand = new Random();

                int chosenFileNumber  = rand.randomInt(files.length,1);

                File file = files[chosenFileNumber - 1];

                System.out.println(file);

                newRoom.roomNum = chosenFileNumber;

                String roomFileName = file.toString();

                newRoom.roomFileName = roomFileName;
            } else if ((path.get(roomsIndex) == 5) && (path.get(roomsIndex - 1) != 5)) {
                String roomPath = System.getProperty("user.dir") + "\\" + "Rooms" + "\\" + path.get(roomsIndex-1) + "1" + "\\";
                ...
                String roomPath = System.getProperty("user.dir") + "\\" + "Rooms" + "\\" + "1" + path.get(roomsIndex) + "\\";
        ...
        for (int i = 0; i < numRooms; i++) {
            ...
            if (i == 0) {
                startingRoom = true;
                init.roomList.get(i).unlockAllDoors(world,init.roomList.get(i),true);
                //doorDirection = 0;
                boolean temp;
    ...
    public boolean testGenerateRoom(boolean startingRoom, int currentDoorDirection, int roomIndex) {
        ...
        try {
            ...
            if (startingRoom) {
                roomFile = init.lp.read( "Rooms" + "\\00\\" + "room0.csv");
                //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex-1) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            }  else if (roomIndex == numRooms - 1 || (path.get(roomIndex-1) == 5|| path.get(roomIndex) == 5 || path.get(roomIndex+1) == 5)) {
                roomFile = init.lp.read( "Rooms" + "\\" + "boss" + "\\" + "1.csv");
            }
            else {
                roomFile = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex+1) + "\\" + "room" + init.roomList.get(roomIndex).roomNum + ".csv");
                //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            }

            //List<List<String>> roomFile = init.lp.read( "Rooms" + "\\" + path.get(roomIndex-1) + path.get(roomIndex) + "\\" + "room" + init.roomList.get(roomIndex).roomNum + ".csv");

            //List<List<String>> roomFile = init.lp.read("Rooms/" + init.roomList.get(roomIndex).previousDirection + init.roomList.get(roomIndex).roomDirection + "/" + init.roomList.get(roomIndex).randomRoomFileNum ".csv");
            ...
            if (!startingRoom && (path.get(roomIndex - 1) == 5 || path.get(roomIndex) == 5)) {
                checkForIntersection(startingRoom, 1, roomIndex);
            } else {
    ...
    public void locateDoors(int roomIndex, int x1, int doorY) {
        try{
            ...
            //List<List<String>> roomFile = init.lp.read( "Rooms" + "\\" + path.get(roomIndex-1) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);

            //List<List<String>> roomFile = init.lp.read( "Rooms" + "\\" + path.get(roomIndex-1) + path.get(roomIndex) + "\\" + "room" + init.roomList.get(roomIndex).roomNum + ".csv");

            if (startingRoom) {
                List<List<String>> roomFile = init.lp.read( "Rooms" + "\\00\\" + "room0.csv");
                //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex-1) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            } else if (( path.get(roomIndex) == 5 || path.get(roomIndex + 1) == 5)) {
                List<List<String>> roomFile = init.lp.read( "Rooms" + "\\" + "boss" + "\\" + init.roomList.get(roomIndex).roomNum + ".csv");
            }


            else {
                List<List<String>> roomFile = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex+1) + "\\" + "room" + init.roomList.get(roomIndex).roomNum + ".csv");
                //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            }
    ...
    public ArrayList generateRoom(World world,
        ...
        try {
            ...
            System.out.println("ROOOOOOOOOOOOOMS INDEX: " + roomIndex);
            if (startingRoom) {
                room = init.lp.read( "Rooms" + "\\00\\" + "room0.csv");
            //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex-1) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            } else if (roomIndex == numRooms - 1 || (path.get(roomIndex) == 5 || path.get(roomIndex+1) == 5)) {
                room = init.lp.read( "Rooms" + "\\" + "boss" + "\\" + "1.csv");
            }
            else {
                room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex+1) + "\\" + "room" + init.roomList.get(roomIndex).roomNum + ".csv");
                //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            //     room = init.lp.read( "Rooms" + "\\" + path.get(roomIndex) + path.get(roomIndex) + "\\" + init.roomList.get(roomIndex).roomFileName);
            }
        ...
        //T0DO Fix - oceanWater should generate EVERYWHERE - with just waves generating on top (maybe lower opacity get the same look as currently?)
            for (int rowNumOc = 0; rowNumOc < currentRoomSize + 4; rowNumOc++) {
                for (int iOc = -4; iOc < layerSize; iOc++) {
                    ...
                    if (waveOffset % 2 == 0) {
                        Wave wave = new Wave(world, ((roomX + iOc) * 16) + 16 * 16 + 32,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + (16 * rowNumOc) - (16 * currentRoomSize) - 16 + 3, 0, true);
                        waves.add(wave);
                    } else {
                        Wave wave = new Wave(world, ((roomX + iOc) * 16) + 16 * 16 + 32,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + (16 * rowNumOc) - (16 * currentRoomSize) - 16 + 3, 0, false);//4.95 4.885  375 4.92
                        waves.add(wave);
                    }
                }
                waveOffset++;
 ...
 */
    ...
    switch (levelTextures.get(i)) {
        ...
        case "middleFloor3Tile":
            ...
            break;
        case "middleFloor3Tile2":
            currentCell = init.cr.middleFloor3Tile2;
            break;
        case "middleFloor4Tile":
        ...
        case "mosaicTrident":
            ...
            break;
        case "mosaicBull":
            currentCell = init.cr.mosaicBullTile;
            break;
        case "mosaicGryphon":
            currentCell = init.cr.mosaicGryphonTile;
            break;
        case "mosaicLyre":
            currentCell = init.cr.mosaicLyreTile;
            break;
        case "mosaicSpartan":
            currentCell = init.cr.mosaicSpartanTile;
            break;
        ...
        case "topStairTile":
            ...
            break;
        case "topStair2Tile":
            currentCell = init.cr.topStair2Tile;
            break;
        ...
        case "upTopLeftStairTile":
            currentCell = init.cr.upTopLeftStairTile;
            break;
        case "upTopRightStairTile":
            currentCell = init.cr.upTopRightStairTile;
            break;
        case "upBottomLeftStairTile":
            currentCell = init.cr.upBottomLeftStairTile;
            break;
        case "upBottomRightStairTile":
        ...
        case "raisedFloorTile":
            ...
            break;
        case "raisedFloorTileWithPot":
            currentCell = init.cr.middleFloorTile2;
            RaisedFloor rafPot = new RaisedFloor(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            int randObRafPot = Random.randomInt(9,1);
            Pot praf = new Pot(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, randObRafPot);
            praf.onRaisedFloor = true;
            pots.add(praf);
            rafPot.createRaisedFloor();
            rafPot.active = false;
            raisedFloors.add(rafPot);
            praf.linkedFloor = rafPot;
            break;
        case "venusDeMilo":
            Statue venus = new Statue(world, (roomX + i) * 16 + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30,3);
            venus.createStatueHitbox(((roomX + i) * 16) + 16 * 16 + 4f,levelY * 16 + Gdx.graphics.getHeight() / 30 + 16f, world);
            statues.add(venus);
            currentCell = init.cr.blockTile;
            Body blockVDM1 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            blockVDM1.setUserData("Wall");
            break;
        case "drain":
            currentCell = init.cr.middleFloorTile;
            Drain newDrain = new Drain(world, ((roomX + i) * 16) + 16 * 16 - 1, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newDrain.createDrain();
            drains.add(newDrain);
            break;
        case "wf1drainwf":
            currentCell = init.cr.middleFloorTile;
            Drain newDrainWaterfallWater = new Drain(world, ((roomX + i) * 16) + 16 * 16 - 1, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newDrainWaterfallWater.createDrain();
            drains.add(newDrainWaterfallWater);
            Waterfall wfw = new Waterfall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 5);
            wfw.createWaterfall();
            waterfalls.add(wfw);
            Water wafdr = new Water(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 2);
            water.add(wafdr);
            wafdr.createWaterBody();
            break;
        case "f1drainwf":
            currentCell = init.cr.middleFloorTile;
            Drain newDrainWaterfall = new Drain(world, ((roomX + i) * 16) + 16 * 16 - 1, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newDrainWaterfall.createDrain();
            drains.add(newDrainWaterfall);
            Waterfall wf = new Waterfall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 5);
            wf.createWaterfall();
            waterfalls.add(wf);
            break;
        case "pit":
            currentCell = init.cr.pitTile;
            Body pit = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pit.setUserData("Pit");
            break;
        case "pitRubble":
            currentCell = init.cr.pitTile;
        ...
        case "pitRubble3":
            ...
            break;
        case "pitRubble1Random":
            currentCell = init.cr.pitTile;
            int randRub1R = Random.randomInt(5,1);
            if (randRub1R == 5) {
                Rubble pitRubble = new Rubble(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 1);
                pitRubble.createRubble();
                rubble.add(pitRubble);
            }
            Body pit1r = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pit1r.setUserData("Pit");
            break;
        case "pitRubble3Random":
            ...
            Body pit3r = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pit3r.setUserData("Pit");
            break;
        case "pitFloor1":
            currentCell = init.cr.pitFloorTile;
            Body pitF1 = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitF1.setUserData("Pit");
            break;
        case "pitFloor2":
            currentCell = init.cr.pitFloor2Tile;
            Body pitF2 = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitF2.setUserData("Pit");
            break;
        case "pitStairs":
            currentCell = init.cr.pitStairsTile;
            Body pitSt = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitSt.setUserData("Pit");
            break;
        case "pitDown":
            currentCell = init.cr.pitBottomTile;
            Body pitD = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitD.setUserData("Pit");
            break;
        case "pitDownLeft":
            currentCell = init.cr.pitBottomLeftTile;
            Body pitDL = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitDL.setUserData("Pit");
            break;
        case "pitDownRight":
            currentCell = init.cr.pitBottomRightTile;
            Body pitDR = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitDR.setUserData("Pit");
            break;
        case "pitLeft":
            currentCell = init.cr.pitLeftTile;
            Body pitL = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            pitL.setUserData("Pit");
            break;
        case "pitRight":
            currentCell = init.cr.pitRightTile;
            Body pitR = init.bf.createPit(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
        ...
        case "topLeftWallTile":
            ...
            break;
        case "largeTopLeftWallTile":
            currentCell = init.cr.largeWallTopLeftTile;
            Body newLargeTopLeftWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopLeftWall.setUserData("Wall");

            Body newLargeTopLeftWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopLeftWall2.setUserData("Wall");

            Body newLargeTopLeftWall3 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopLeftWall3.setUserData("Wall");

            Body newLargeTopLeftWall4 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopLeftWall4.setUserData("Wall");
            break;
        case "largeTopLeftWallTurnTile":
            currentCell = init.cr.largeWallTopLeftTurnTile;
            Body newLargeTopLeftWallTurn = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30,15.9f, 0.1f);
            newLargeTopLeftWallTurn.setUserData("Wall");

            Body newLargeTopLeftWallTurn1 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopLeftWallTurn1.setUserData("Wall");

            Body newLargeTopLeftWallTurn2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopLeftWallTurn2.setUserData("Wall");
            break;
        case "topWallTile":
            ...
            break;
        case "largeTopWallTile":
            currentCell = init.cr.largeWallUpTile;
            Body newLargeTopWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopWall.setUserData("Wall");

            Body newLargeTopWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopWall2.setUserData("Wall");
        ...
        case "topWallFireTrapTile":
            ...
            break;
        case "largeTopWallTrapTile":
            currentCell = init.cr.largeWallUpTile;
            Body newLargeTopWallTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopWallTrap.setUserData("Wall");

            Body newLargeTopWallTrap2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopWallTrap2.setUserData("Wall");

            Trap largeTopWallTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,1, 1);
            largeTopWallTrap.createTrap();
            traps.add(largeTopWallTrap);
            break;
        case "largeTopWallFireTrapTile":
            currentCell = init.cr.largeWallUpTile;
            Body newLargeTopWallFireTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopWallFireTrap.setUserData("Wall");
            Trap largeTopWallFireTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,2, 1);
            largeTopWallFireTrap.createTrap();
            traps.add(largeTopWallFireTrap);
            break;
        case "topRightWallTile":
            ...
            break;
        case "largeTopRightWallTile":
            currentCell = init.cr.largeWallTopRightTile;
            Body newLargeTopRightWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopRightWall.setUserData("Wall");

            Body newLargeTopRightWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopRightWall2.setUserData("Wall");

            Body newLargeTopRightWall3 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeTopRightWall3.setUserData("Wall");

            Body newLargeTopRightWall4 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeTopRightWall4.setUserData("Wall");
            break;
        case "leftWallTile":
            ...
            break;
        case "largeLeftWallTile":
            currentCell = init.cr.largeWallLeftTile;
            Body newLargeLeftWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeLeftWall.setUserData("Wall");
            Body newLargeLeftWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeLeftWall2.setUserData("Wall");
            break;
        ...
        case "leftWallFireTrapTile":
            ...
            break;
        case "largeLeftWallTrapTile":
            currentCell = init.cr.largeWallLeftTile;
            Body newLargeLeftWallTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 0.5f);
            newLargeLeftWallTrap.setUserData("Wall");

            Body newLargeLeftWallTrap2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 0.5f);
            newLargeLeftWallTrap2.setUserData("Wall");

            Trap largeLeftWallTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 2.5f,1, 4);
            largeLeftWallTrap.createTrap();
            traps.add(largeLeftWallTrap);
            break;
        case "largeLeftWallFireTrapTile":
            currentCell = init.cr.largeWallLeftTile;
            Body newLargeLeftWallFireTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeLeftWallFireTrap.setUserData("Wall");
            Trap largeLeftWallFireTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 2.5f,2, 4);
            largeLeftWallFireTrap.createTrap();
            traps.add(largeLeftWallFireTrap);
            break;
        case "rightWallTile":
            ...
            break;
        case "largeRightWallTile":
            currentCell = init.cr.largeWallRightTile;
            Body newLargeRightWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeRightWall.setUserData("Wall");
            Body newLargeRightWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeRightWall2.setUserData("Wall");
            break;
        ...
        case "rightWallFireTrapTile":
            ...
            break;
        case "largeRightWallTrapTile":
            currentCell = init.cr.largeWallRightTile;
            Body newLargeRightWallTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 0.5f);
            newLargeRightWallTrap.setUserData("Wall");

            Body newLargeRightWallTrap2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 0.5f);
            newLargeRightWallTrap2.setUserData("Wall");

            Trap largeRightWallTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30f + 2.5f,1, 2);
            largeRightWallTrap.createTrap();
            traps.add(largeRightWallTrap);
            break;
        case "largeRightWallFireTrapTile":
            currentCell = init.cr.largeWallRightTile;
            Body newLargeRightWallFireTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeRightWallFireTrap.setUserData("Wall");
            Trap largeRightWallFireTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 + 2.5f,2, 2);
            largeRightWallFireTrap.createTrap();
            traps.add(largeRightWallFireTrap);
            break;
        case "bottomLeftWallTile":
            ...
            break;
        case "largeBottomLeftWallTurnTile":
            currentCell = init.cr.largeWallBottomLeftTurnTile;
            Body newLargeBottomLeftTurnWall = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 15.9f, 15.9f);
           // Body newLargeBottomLeftWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomLeftTurnWall.setUserData("Wall");
            //TODO: ADD BACK WALL
            break;
        case "largeBottomLeftWallTile":
            currentCell = init.cr.largeWallBottomLeftTile;
            Body newLargeBottomLeftWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomLeftWall.setUserData("Wall");

            Body newLargeBottomLeftWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomLeftWall2.setUserData("Wall");

            Body newLargeBottomLeftWall3 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomLeftWall3.setUserData("Wall");

            Body newLargeBottomLeftWall4 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomLeftWall4.setUserData("Wall");
            break;
        case "bottomLeftTurnWallTile":
            currentCell = init.cr.bottomLeftTurnTile;
            Body newBottomLeftTurnWall = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 15.9f, 15.9f);
            newBottomLeftTurnWall.setUserData("Wall");
            break;
        case "bottomWallTile":
            ...
            break;
        case "largeBottomWallTile":
            currentCell = init.cr.largeWallDownTile;
            Body newLargeBottomWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomWall.setUserData("Wall");
            Body newLargeBottomWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomWall2.setUserData("Wall");
            break;
        ...
        case "bottomWallFireTrapTile":
            ...
            break;
        case "largeBottomWallTrapTile":
            currentCell = init.cr.largeWallDownTile;
            Body newLargeBottomWallTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomWallTrap.setUserData("Wall");

            Body newLargeBottomWallTrap2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomWallTrap2.setUserData("Wall");

            Trap largeBottomWallTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30,1, 3);
            largeBottomWallTrap.createTrap();
            traps.add(largeBottomWallTrap);
            break;
        case "largeBottomWallFireTrapTile":
            currentCell = init.cr.largeWallDownTile;
            Body newLargeBottomWallFireTrap = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomWallFireTrap.setUserData("Wall");
            Trap largeBottomWallFireTrap = new Trap(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30,2, 3);
            largeBottomWallFireTrap.createTrap();
            traps.add(largeBottomWallFireTrap);
            break;
        case "bottomRightWallTile":
            ...
            break;
        case "largeBottomRightWallTile":
            currentCell = init.cr.largeWallBottomRightTile;
            Body newLargeBottomRightWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomRightWall.setUserData("Wall");

            Body newLargeBottomRightWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomRightWall2.setUserData("Wall");

            Body newLargeBottomRightWall3 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30- 16);
            newLargeBottomRightWall3.setUserData("Wall");

            Body newLargeBottomRightWall4 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomRightWall4.setUserData("Wall");
            break;
        case "largeBottomRightWallTurnTile":
            currentCell = init.cr.largeWallBottomRightTurnTile;
            Body newLargeBottomRightWallTurn = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30,15.9f, 0.1f);
            newLargeBottomRightWallTurn.setUserData("Wall");

            Body newLargeBottomRightWallTurn1 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newLargeBottomRightWallTurn1.setUserData("Wall");

            Body newLargeBottomRightWallTurn2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newLargeBottomRightWallTurn2.setUserData("Wall");
            break;
        case "topLeftTurnWallTile":
        ...
        case "bottomRightTurnFenceTile":
            ...
            Body newBottomRightTurnFence = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 0.1f, 15.9f);
            newBottomRightTurnFence.setUserData("Wall");
            break;
        case "bottomLeftTurnFenceTile":
            currentCell = init.cr.bottomLeftTurnFenceTile;
            Body newBottomLeftTurnFence = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 15.9f, 15.9f);
            newBottomLeftTurnFence.setUserData("Wall");
            break;
        case "topRightTurnFenceTile":
            currentCell = init.cr.topRightTurnFenceTile;
            Body newTopRightTurnFence = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 0.1f, 0.1f);
            newTopRightTurnFence.setUserData("Wall");
            break;
        case "topLeftTurnFenceTile":
            currentCell = init.cr.topLeftTurnFenceTile;
            Body newTopLeftTurnFence = init.bf.createWallTurn(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 15.9f, 0.1f);
        ...
        case "doorTopLeftWall":
            if (((nextDirection == 1 || doorDirection == 3))) {
                ...
                Body newDoorTopLeftWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
                newDoorTopLeftWall2.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallUpTile;
                ...
                Body newTopWallCover2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
                newTopWallCover2.setUserData("Wall");
                break;
            }
        case "doorTopRightWall":
            if (((nextDirection == 1 || doorDirection == 3))) {
                ...
                Body newDoorTopRightWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
                newDoorTopRightWall2.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallUpTile;
                Body newTopWallCover = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
        ...
        case "doorLeftUpperWall":
            if (doorLeft <= 1 && ((nextDirection == 4 || doorDirection == 2))) {
                ...
                Body newDoorLeftUpperWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newDoorLeftUpperWall.setUserData("Wall");

                Body newDoorLeftUpperWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newDoorLeftUpperWall2.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallLeftTile;
                Body newLeftWallCover = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newLeftWallCover.setUserData("Wall");

                Body newLeftWallCover2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newLeftWallCover2.setUserData("Wall");
                break;
            }
        case "doorLeftLowerWall":
            if (doorLeft <= 2 && ((nextDirection == 4 || doorDirection == 2))) {
                currentCell = init.cr.doorLeftLowerWall;
                Body newDoorLeftLowerWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newDoorLeftLowerWall.setUserData("Wall");

                Body newDoorLeftLowerWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newDoorLeftLowerWall2.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallLeftTile;
                Body newLeftWallCover = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
        ...
        case "doorRightUpperWall":
            if (((nextDirection == 2 || doorDirection == 4))) {
                ...
                Body newDoorRightUpperWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newDoorRightUpperWall2.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallRightTile;
                ...
                Body newRightWallCover2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newRightWallCover2.setUserData("Wall");
                break;
            }
        ...
        case "doorRightLowerWall":
            if (((nextDirection == 2 || doorDirection == 4))) {
                ...
                Body newDoorRightLowerWall2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newDoorRightLowerWall2.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallRightTile;
                Body newRightWallCover = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
        ...
        case "doorBottomLeftWall":
            if (doorBottom <= 1 && ((nextDirection == 3 || doorDirection == 1))) {
                ...
                Body newDoorBottomLeftWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
                newDoorBottomLeftWall.setUserData("Wall");
                break;
            } else {
                currentCell = init.cr.largeWallDownTile;
                Body newBottomWallCover = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
                newBottomWallCover.setUserData("Wall");
                Body newBottomWallCover2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
                newBottomWallCover2.setUserData("Wall");
                break;
            }
        case "doorBottomRightWall":
            if (doorBottom <= 2 && (nextDirection == 3 || doorDirection == 1)) {
                currentCell = init.cr.doorBottomRightWall;
                Body newDoorBottomRightWall = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
        ...
        case "doorTopLeft":
            if (!startingRoom) {
                if (doorTop <= 1 && ((nextDirection == 1 || doorDirection == 3))) {
                    Door newDoorTopLeft = new Door(world, "TopLeft", init.roomList.get(roomIndex).doorLocations.get("TopLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, true, roomNum, 1);
        ...
        case "doorTopLeftFence":
            if (!startingRoom) {
                if (doorTop <= 1 && ((nextDirection == 1 || doorDirection == 3))) {
                    Door newDoorTopLeft = new Door(world, "TopLeft", init.roomList.get(roomIndex).doorLocations.get("TopLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, true, roomNum, 2);
                    newDoorTopLeft.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("TopLeft", newDoorTopLeft);
                    init.roomList.get(roomIndex).doors.add(newDoorTopLeft);
        ...
        case "doorTopRight":
            if (!startingRoom) {
                if (doorTop <= 1 && ((nextDirection == 1 || doorDirection == 3))) {
                    ...
                    Door newDoorTopRight = new Door(world, "TopRight", init.roomList.get(roomIndex).doorLocations.get("TopRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, false, roomNum, 1);
        ...
        case "doorTopRightFence":
            if (!startingRoom) {
                if (doorTop <= 1 && ((nextDirection == 1 || doorDirection == 3))) {
                    ...
                    Door newDoorTopRight = new Door(world, "TopRight", init.roomList.get(roomIndex).doorLocations.get("TopRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, false, roomNum, 2);
                    newDoorTopRight.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("TopRight", newDoorTopRight);
                    init.roomList.get(roomIndex).doors.add(newDoorTopRight);
        ...
        case "doorLeftUpper":
            if (!startingRoom) {
                if (doorLeft <= 1 && ((nextDirection == 4 || doorDirection == 2))) {
                    ...
                    Door newDoorLeftUpper = new Door(world, "UpperLeft", init.roomList.get(roomIndex).doorLocations.get("UpperLeft"), ((roomX + i) * 16) + 16 * 16 + 2, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, true, roomNum, 1);
        ...
        case "doorLeftUpperFence":
            if (!startingRoom) {
                if (doorLeft <= 1 && ((nextDirection == 4 || doorDirection == 2))) {
                    ...
                    Door newDoorLeftUpper = new Door(world, "UpperLeft", init.roomList.get(roomIndex).doorLocations.get("UpperLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, true, roomNum, 2);
                    newDoorLeftUpper.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("UpperLeft", newDoorLeftUpper);
                    init.roomList.get(roomIndex).doors.add(newDoorLeftUpper);
        ...
        case "doorLeftLower":
            ...
            if (!startingRoom) {
                if (doorLeft <= 1 && ((nextDirection == 4 || doorDirection == 2))) {
                    ...
                    Door newDoorLeftLower = new Door(world, "LowerLeft", init.roomList.get(roomIndex).doorLocations.get("LowerLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, false, roomNum, 1);
        ...
        case "doorLeftLowerFence":
            ...
            if (!startingRoom) {
                if (doorLeft <= 1 && ((nextDirection == 4 || doorDirection == 2))) {
                    ...
                    Door newDoorLeftLower = new Door(world, "LowerLeft", init.roomList.get(roomIndex).doorLocations.get("LowerLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, false, roomNum, 2);
                    newDoorLeftLower.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("LowerLeft", newDoorLeftLower);
                    init.roomList.get(roomIndex).doors.add(newDoorLeftLower);
        ...
        case "doorRightUpper":
            if (!startingRoom) {
                if (doorRight <= 1 && ((nextDirection == 2 || doorDirection == 4))) {
                    ...
                    Door newDoorRightUpper = new Door(world, "UpperRight", init.roomList.get(roomIndex).doorLocations.get("UpperRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, true, roomNum, 1);
        ...
        case "doorRightUpperFence":
            if (!startingRoom) {
                if (doorRight <= 1 && ((nextDirection == 2 || doorDirection == 4))) {
                    ...
                    Door newDoorRightUpper = new Door(world, "UpperRight", init.roomList.get(roomIndex).doorLocations.get("UpperRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, true, roomNum, 2);
                    newDoorRightUpper.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("UpperRight", newDoorRightUpper);
                    init.roomList.get(roomIndex).doors.add(newDoorRightUpper);
        ...
        case "doorRightLower":
            if (!startingRoom) {
                if (doorRight <= 2 && ((nextDirection == 2 || doorDirection == 4))) {
                    ...
                    Door newDoorRightLower = new Door(world, "LowerRight", init.roomList.get(roomIndex).doorLocations.get("LowerRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, false, roomNum, 1);
        ...
        case "doorRightLowerFence":
            if (!startingRoom) {
                if (doorRight <= 2 && ((nextDirection == 2 || doorDirection == 4))) {
                    ...
                    Door newDoorRightLower = new Door(world, "LowerRight", init.roomList.get(roomIndex).doorLocations.get("LowerRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, true, false, roomNum, 2);
                    newDoorRightLower.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("LowerRight", newDoorRightLower);
                    init.roomList.get(roomIndex).doors.add(newDoorRightLower);
                    ...
                    currentCell = init.cr.rightFenceTile;
                    Body newRightWallCover = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
                    newRightWallCover.setUserData("Wall");
                    break;
                }
            }
        ...
        case "doorBottomLeft":
            if (!startingRoom) {
                if (doorBottom <= 1 && ((nextDirection == 3 || doorDirection == 1))) {
                    ...
                    Door newDoorBottomLeft = new Door(world, "BottomLeft", init.roomList.get(roomIndex).doorLocations.get("BottomLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, true, roomNum, 1);
        ...
        case "doorBottomLeftFence":
            if (!startingRoom) {
                if (doorBottom <= 1 && ((nextDirection == 3 || doorDirection == 1))) {
                    ...
                    Door newDoorBottomLeft = new Door(world, "BottomLeft", init.roomList.get(roomIndex).doorLocations.get("BottomLeft"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, true, roomNum, 2);
                    newDoorBottomLeft.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("BottomLeft", newDoorBottomLeft);
                    init.roomList.get(roomIndex).doors.add(newDoorBottomLeft);
        ...
        case "doorBottomRight":
            if (!startingRoom) {
                if (doorBottom <= 1 && (nextDirection == 3 || doorDirection == 1)) {
                    ...
                    Door newDoorBottomRight = new Door(world, "BottomRight", init.roomList.get(roomIndex).doorLocations.get("BottomRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, false, roomNum, 1);
        ...
        case "doorBottomRightFence":
            if (!startingRoom) {
                if (doorBottom <= 1 && (nextDirection == 3 || doorDirection == 1)) {
                    ...
                    Door newDoorBottomRight = new Door(world, "BottomRight", init.roomList.get(roomIndex).doorLocations.get("BottomRight"), ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, false, false, roomNum, 2);
                    newDoorBottomRight.createDoor();
                    init.roomList.get(roomIndex).doorArrayMap.put("BottomRight", newDoorBottomRight);
                    init.roomList.get(roomIndex).doors.add(newDoorBottomRight);
        ...
        case "obstacle4":
            currentCell = init.cr.middleFloorTile;
            Obstacle newObstacle4 = new Obstacle(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 4);
            obstacles.add(newObstacle4);
            break;
        case "obstacle5":
            currentCell = init.cr.middleFloorTile;
            Obstacle newObstacle5 = new Obstacle(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 5);
            obstacles.add(newObstacle5);
            break;
        case "obstacle6":
            currentCell = init.cr.middleFloorTile;
            Obstacle newObstacle6 = new Obstacle(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 6);
            obstacles.add(newObstacle6);
            break;
        case "obstacle7":
            currentCell = init.cr.middleFloorTile;
            Obstacle newObstacle7 = new Obstacle(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 7);
            obstacles.add(newObstacle7);
            break;

        case "waterRimLeft":
            currentCell = init.cr.waterRimLeft;
            break;
        case "waterRimRight":
            currentCell = init.cr.waterRimRight;
            break;
        case "waterRimTop":
            currentCell = init.cr.waterRimTop;
            break;
        case "waterRimBottom":
            currentCell = init.cr.waterRimBottom;
            break;

        case "brokenColumnBase1":
            currentCell = init.cr.middleFloorTile;
            Column colbr1 = new Column();
            columns.add(colbr1);
            ColumnPiece colBrokenBase1 = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 12,80);
            colBrokenBase1.base = true;
            colBrokenBase1.createColumnBase();
            colbr1.addPiece(colBrokenBase1);
            ColumnPiece colBrokenBaseLower1 = new ColumnPiece(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 780);
            colBrokenBaseLower1.createColumnBaseLower(false);
            colbr1.createBrokenBaseHitbox(0, false, colBrokenBase1.columnX, colBrokenBase1.columnY,world);
            break;
        case "brokenColumnBase2":
            currentCell = init.cr.middleFloorTile;
            ColumnPiece colBrokenBase2 = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,90);
            colBrokenBase2.createColumnBase();
            colBrokenBase2.base = true;
            ColumnPiece colBrokenBaseLower2 = new ColumnPiece(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 790);
            colBrokenBaseLower2.createColumnBaseLower(true);
            break;
        case "brokenColumnBase3":
            currentCell = init.cr.middleFloorTile;
            ColumnPiece colBrokenBase3 = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,100);
            colBrokenBase3.createColumnBase();
            colBrokenBase3.base = true;
            ColumnPiece colBrokenBaseLower3 = new ColumnPiece(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 800);
            colBrokenBaseLower3.createColumnBaseLower(true);
            break;
        case "lamp":
            currentCell = init.cr.middleFloorTile;
            OilLamp newOilLamp = new OilLamp(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16, 1);
            Body lampBody = newOilLamp.createLamp();
            Fire fLamp = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 11f,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 6.5f, false,0f, 6, false, 0);
            fires.add(fLamp);
            fLamp.createFire(new Color(0.30f,0.12f,0,0.65f),30, null);
            lamps.add(newOilLamp);
            lights.add(fLamp);
            break;

        case "cand":
            currentCell = init.cr.middleFloorTile;
            Candle newCandle = new Candle(world, ((roomX + i) * 16) + 16 * 16 - 1, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 1.5f, 1);
            Body candBody = newCandle.createCandle();
            Fire fCan = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 7f,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 2f, false,0f, 6, false, 0);
            fires.add(fCan);
        ...
        case "2cands":
            ...
            Fire fCans22 = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 5f,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 2.5f, false,0f, 6, false, 0);
            fires.add(fCans22);
            lights.add(fCans22);
            fCans22.createFire(new Color(0.30f,0.12f,0,0.5f),20, null);
            Fire fCans222 = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 9f,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 6.5f, false,0f, 6, false, 0);
            fires.add(fCans222);
            lights.add(fCans222);
        ...
        case "torl":
            currentCell = init.cr.largeWallLeftTile;
            Body newTorchWallLeft = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallLeft.setUserData("Wall");
            Body newTorchWallLeft2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallLeft2.setUserData("Wall");
            Torch torL = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 14, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) - 13, 3);
            Fire fL = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 12 + 17,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16), true,0f, 3, false, 4);
            fires.add(fL);
            torches.add(torL);
            lights.add(torL);
        ...
        case "torlb":
            ...
            Body newTorchWallLeftBlue = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallLeftBlue.setUserData("Wall");
            Torch torLB = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 6, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8, 3);
            Fire fLB = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 4,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 4, true,0f, 3, false, 4);
            fires.add(fLB);
            torches.add(torLB);
            lights.add(torLB);
            ConeLight torchLightLB = torLB.createTorch(4);
            Color colorBLB = new Color(0f,0,1f,0.7f);

            fLB.blue = true;
            fLB.createFire(colorBLB,60,torchLightLB);
            init.roomList.get(roomIndex).fires.add(fLB);
            break;
        case "torloff":
            currentCell = init.cr.torchWallLeftTile;
            ...
            Body newTorchWallLeftOff2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 - 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallLeftOff2.setUserData("Wall");
            Torch torLoff = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 6, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8,3);
        ...
        case "torr":
            ...
            Body newTorchWallRight2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16 + 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallRight2.setUserData("Wall");
            Torch torR = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 20, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 3,4);
            Fire fR = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 3,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 15, true,0f, 3, false, 2);
            fires.add(fR);
            torches.add(torR);
            lights.add(torR);
            ...
            Color colorBRB = new Color(0f,0,1f,0.7f);

            if (roomNum == 13) {
                fR.blue = true;
                fR.createFire(colorBRB,60,torchLightR);
        ...
        case "torrb":
            ...
            Body newTorchWallRightBlue = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallRightBlue.setUserData("Wall");
            Torch torRB = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 10, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8,4);
            Fire fRB = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 7,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 4, true,0f, 3, false, 2);
            fires.add(fRB);
            torches.add(torRB);
            lights.add(torRB);
            ConeLight torchLightRB = torRB.createTorch(2);

            Color colorBR = new Color(0f,0,1f,0.7f);

            fRB.blue = true;
            fRB.createFire(colorBR,60,torchLightRB);
            init.roomList.get(roomIndex).fires.add(fRB);
        ...
        case "torroff":
            ...
            Torch torRoff = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 10, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8,4);
        ...
        case "toru":
            ...
            Body newTorchWallUp2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newTorchWallUp2.setUserData("Wall");

            Torch torU = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 8.5f, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 15,1);
            Fire fU = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 5f,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 5, true,0f, 3, false, 1);
            fires.add(fU);
            torches.add(torU);
            lights.add(torU);
        ...
        case "torub":
            ...
            Body newTorchWallUpBlue = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallUpBlue.setUserData("Wall");
            Torch torUB = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 8, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 15,1);
            Fire fUB = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 - 5,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 - 5, true,0f, 3, false, 1);
            fires.add(fUB);
            torches.add(torUB);
            lights.add(torUB);
            ConeLight torchLightUBlue = torUB.createTorch(1);
            Color colorBUB = new Color(0f,0,1f,0.7f);
            fUB.blue = true;
            fUB.createFire(colorBUB,60,torchLightUBlue);
            init.roomList.get(roomIndex).fires.add(fUB);
        ...
        case "toruoff":
            ...
            Torch torUoff = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 8, (levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 15,1);
        ...
        case "tord":
            currentCell = init.cr.largeWallDownTile;
            Body newTorchWallDown = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30);
            newTorchWallDown.setUserData("Wall");

            Body newTorchWallDown2 = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallDown2.setUserData("Wall");

            Torch torD = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 4, levelY * 16 + Gdx.graphics.getHeight() / 30 - 2,2);
            Fire fD = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 + 10,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 + 21, true,0f, 3, true, 3);
            fires.add(fD);
            torches.add(torD);
            lights.add(torD);
        ...
        case "tordb":
            ...
            Body newTorchWallDownBlue = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            newTorchWallDownBlue.setUserData("Wall");
            Torch torDB = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 8, levelY * 16 + Gdx.graphics.getHeight() / 30 - 10,2);
            Fire fDB = new Fire(world,rayHandler,(((roomX + i) * 16) + 16 * 16) + 6 + 10,(levelY * 16 + Gdx.graphics.getHeight() / 30 - 16) + 8 + 7, true,0f, 3, true, 3);
            fires.add(fDB);
            torches.add(torDB);
            lights.add(torDB);
            ConeLight torchLightDB = torDB.createTorch(3);
            Color colorFDB = new Color(0.30f,0.12f,0,0.7f);
            Color colorBDB = new Color(0f,0,1f,0.7f);

                fDB.blue = true;
                fDB.createFire(colorBDB,60,torchLightDB);
                init.roomList.get(roomIndex).fires.add(fDB);
            break;
        case "tordoff":
            currentCell = init.cr.torchWallDownTile;
            ...
            Torch torDoff = new Torch(rayHandler, world, (((roomX + i) * 16) + 16 * 16) + 8, levelY * 16 + Gdx.graphics.getHeight() / 30 - 10,2);
        ...
        case "vasebl":
           // currentCell = init.cr.middleFloorTile;
            Vase vasebl = new Vase(world, ((roomX + i) * 16) + 16 * 16 + 0.5f, levelY * 16 + Gdx.graphics.getHeight() / 30);
            vasebl.createVase();
            vases.add(vasebl);
            currentCell = init.cr.blockTile;
            Body blockVase = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            blockVase.setUserData("Wall");
            break;

        case "vaseblomega":
           // currentCell = init.cr.middleFloorTile;
            Vase vaseblOmega = new Vase(world, ((roomX + i) * 16) + 16 * 16 + 0.5f, levelY * 16 + Gdx.graphics.getHeight() / 30);
            vaseblOmega.createVase();
            vases.add(vaseblOmega);
            currentCell = init.cr.blockOmegaTile;
            Body blockVaseOmega = init.bf.createWall(world, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            blockVaseOmega.setUserData("Wall");
            break;
        ...
        case "enemyCyclops":
            ...
            break;
        case "enemyCrab":
            int randIntFloorCrab = Random.randomInt(floor2Chance,1);
            if (randIntFloorCrab != floor2Chance) {
                currentCell = init.cr.middleFloorTile;
            } else {
                currentCell = init.cr.middleFloorTile2;
            }
        ...
        case "pitGryphon":
            currentCell = init.cr.pitTile;
            EnemyGryphon enemy6pit = new EnemyGryphon(DungeonCrawler.world, ((roomX + i) * 16) + 16 * 16 + 8, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 8);
            init.roomList.get(roomIndex).enemyCounter++;
            init.roomList.get(roomIndex).enemyGryphons.add(enemy6pit);
            enemy6pit.createEnemy(7, 14);
            enemies.add(enemy6pit);
            enemy6pit.room = roomIndex;
            enemyGryphons.add(enemy6pit);
            break;
        case "enemyGryphon":
            int randIntFloorGryphon = Random.randomInt(floor2Chance,1);
            if (randIntFloorGryphon != floor2Chance) {
                currentCell = init.cr.middleFloorTile;
            } else {
                currentCell = init.cr.middleFloorTile2;
            }
            EnemyGryphon enemy6 = new EnemyGryphon(DungeonCrawler.world, ((roomX + i) * 16) + 16 * 16 + 8, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 8);
            init.roomList.get(roomIndex).enemyCounter++;
            init.roomList.get(roomIndex).enemyGryphons.add(enemy6);
            enemy6.createEnemy(7, 14);
            enemies.add(enemy6);
        ...
        case "enemySkull3":
            currentCell = init.cr.middleFloor3Tile;
            EnemySkull enemy13 = new EnemySkull(DungeonCrawler.world, ((roomX + i) * 16) + 16 * 16 + 8, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 8);
            init.roomList.get(roomIndex).enemyCounter++;
            init.roomList.get(roomIndex).enemySkulls.add(enemy13);
            enemy13.createEnemy(1, 12);
            enemies.add(enemy13);
            enemy13.room = roomIndex;
            DungeonCrawler.enemySkulls.add(enemy13);
            break;
        case "bossMinotaur":
            currentCell = init.cr.middleFloorTile;
            ...
            //make Minotaur face downward
            boss1.enemyBody.applyLinearImpulse(0,-1,0,0,true);
            break;

        case "shop":
            currentCell = init.cr.middleFloor3Tile;

            DisplayText shopMessage = new DisplayText(DungeonCrawler.defaultFont, "WELCOME!", Color.WHITE, true, 1f, 0.0200f, false, false, null, 0);
            speechMinX = -10;
            speechMaxX = 10;
            ...
            switch (randomChosenIndex) {
                ...
                DisplayText t2 = shopkeeper.Stock(itemKind, i2);
                DisplayText t3 = shopkeeper.DescribeStock(itemKind, i2, cost);
        ...
        case "fped3heal":
            currentCell = init.cr.middleFloorTile;
            ColumnPiece ped3heal = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,16);
            ped3heal.createPedestal();
            Potion potion3 = new Potion(world, ((roomX + i) * 16) + 16 * 16 + 8, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 20, 1);
            potion3.createPotion(potionArrayMap, rayHandler);
            potions.add(potion3);
            potionArrayMap.put(potion3.potionBody, potion3);
            break;
        case "fped4":
            currentCell = init.cr.middleFloorTile;
        ...
        case "fped4fire":
            currentCell = init.cr.middleFloorTile;
            ColumnPiece ped4fire = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,17);
            ped4fire.createPedestal();
            Fire fireped4 = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 2 + 1, true, 0f, 1, false, 0);
            fireped4.createFire(new Color(0.30f,0.12f,0,0.75f), 60, null);
            fires.add(fireped4);
            lights.add(fireped4);
            break;
        case "f3ped4fire":
            ...
            f3fireped4.createFire(new Color(0.30f,0.12f,0,0.75f), 60, null);
            fires.add(f3fireped4);
            lights.add(f3fireped4);
            break;
        case "fped4fireoff":
            currentCell = init.cr.middleFloorTile;
            ColumnPiece ped4fireoff = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,17);
            ped4fireoff.createPedestal();
            Fire fireped4off = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 3, true, 0f, 1, false, 0);
            fireped4off.createFire(new Color(0.30f,0.12f,0,0.75f), 60, null);
            fires.add(fireped4off);
            lights.add(fireped4off);
            fireped4off.extinguish = false;
            fireped4off.smoking = true;
            fireped4off.active = false;
            break;
        case "fped1heal":
            currentCell = init.cr.middleFloorTile;
        ...
        case "f3ped1statue1":
            currentCell = init.cr.middleFloor3Tile;
            ColumnPiece f3ped1statue = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,14);
            f3ped1statue.createPedestal();
            Statue f3ped1Stat1 = new Statue(world, ((roomX + i) * 16) + 16 * 16 + 3, levelY * 16 + Gdx.graphics.getHeight() / 30 + 2,1);
            f3ped1Stat1.createStatueHitbox(((roomX + i) * 16) + 16 * 16 + 4f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 16.5f, world);
            f3ped1Stat1.createStatuePedestalHitbox(((roomX + i) * 16) + 16 * 16 + 4f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 14f, world);
            statues.add(f3ped1Stat1);
            //Body ped1st1 = init.bf.createStatuePedestalHitbox(world, ((roomX + i) * 16) + 16 * 16 + 4f, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 16.5f);
            break;
        case "f3ped1statue2":
            currentCell = init.cr.middleFloor3Tile;
            ColumnPiece f3ped1statue2 = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,14);
            f3ped1statue2.createPedestal();
            Statue f3ped1Stat2 = new Statue(world, ((roomX + i) * 16) + 16 * 16 + 3, levelY * 16 + Gdx.graphics.getHeight() / 30 + 2,2);
            f3ped1Stat2.createStatueHitbox(((roomX + i) * 16) + 16 * 16 + 4f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 16.5f, world);
            f3ped1Stat2.createStatuePedestalHitbox(((roomX + i) * 16) + 16 * 16 + 4f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 14f, world);
            statues.add(f3ped1Stat2);
            //Body ped1st1 = init.bf.createStatuePedestalHitbox(world, ((roomX + i) * 16) + 16 * 16 + 4f, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 16.5f);
            break;
        case "fped2heal":
            currentCell = init.cr.middleFloorTile;
        ...
        case "fped1fire":
            ...
            Fire fireped1 = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 6 + 1f, true, 0f, 1, false, 0);
            fireped1.createFire(new Color(0.30f,0.12f,0,0.75f), 60, null);
            fires.add(fireped1);
            lights.add(fireped1);
            FirePit fp = new FirePit(world, ((roomX + i) * 16) + 16 * 16 + 8f, levelY * 16 + Gdx.graphics.getHeight() / 30 - 1f);
            fp.createFirepit();
            firepits.add(fp);
            /*
            Brazier newBrazier = new Brazier(world, ((roomX + i) * 16) + 16 * 16 + 0.5f, levelY * 16 + Gdx.graphics.getHeight() / 30 - 5f, 2);
            newBrazier.createBrazier();
            braziers.add(newBrazier);
        ...
        case "fped1fireB":
            ...
            Fire fireped1b = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 8, true, 0f, 2, false, 0);
        ...
        case "f2ped1fire":
            currentCell = init.cr.middleFloor2Tile;
            ColumnPiece f2ped1fire = new ColumnPiece(world,((roomX + i) * 16) + 16 * 16,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16,14);
            f2ped1fire.createPedestal();
            Fire f2fireped1 = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + 6 + 1f, true, 0f, 1, false, 0);
            f2fireped1.createFire(new Color(0.30f,0.12f,0,0.75f), 60, null);
            fires.add(f2fireped1);
            lights.add(f2fireped1);
            FirePit f2fp = new FirePit(world, ((roomX + i) * 16) + 16 * 16 + 8f, levelY * 16 + Gdx.graphics.getHeight() / 30 - 1f);
            f2fp.createFirepit();
            firepits.add(f2fp);
            /*
            Brazier newBrazier = new Brazier(world, ((roomX + i) * 16) + 16 * 16 + 0.5f, levelY * 16 + Gdx.graphics.getHeight() / 30 - 5f, 2);
        ...
        default: {
            ...
            if (levelTextures.get(i).matches("f3coltu.+")) {//tuscan
            ...
            if (levelTextures.get(i).matches("cfltS.+")) {//tuscan with full squared base and fire
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,50,750,true,true,1,false,0, false, 0,false, 0);
            }
            if (levelTextures.get(i).matches("cflts.+")) {//tuscan with squared base and fire
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,40,740,false,true,1,false,0, false, 0,false, 0);
            }
            ...
            if (levelTextures.get(i).matches("cfltp.+")) {//tuscan with squared base on podium with fire
            ...
            if (levelTextures.get(i).matches("csftP.+")) {//tuscan with male statue and flag and circular base on podium
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,70,770,true,false,0,true,1, true, 1,false, 0);
            }
            if (levelTextures.get(i).matches("cSftP.+")) {//tuscan with female statue and flag and circular base on podium
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,70,770,true,false,0,true,1, true, 2,false, 0);
            }
            ...
            if (levelTextures.get(i).matches("coltb.+")) {//tuscan with full circular base with torch
                Column coltu = new Column();
            ...
            if (levelTextures.get(i).matches("cslio.+")) {//doric with male statue
                Column colio = new Column();
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 1,4,7,70,false,false,0,false,0, true,1, false,0);
            }
            if (levelTextures.get(i).matches("cSlio.+")) {//ionic with female statue
                Column colio = new Column();
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 1,4,7,70,false,false,0,false,0, true,2, false,0);
            }
            ...
            if (levelTextures.get(i).matches("f3cfltb.+")) {//floor 3 tile tuscan with fire and full circular base
                Column coltu = new Column();
            ...
            if (levelTextures.get(i).matches("cfftp.+")) {//tuscan with fire and flag and full squared base on podium
                Column coltu = new Column();
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,60,760,true,true,0,true,1, false,0, false,0);
            }
            if (levelTextures.get(i).matches("cottp.+")) {//tuscan with fire and flag and full squared base on podium
                Column coltu = new Column();
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,60,760,true,false,0,false,0, false,0, true,3);
            }
            ...
            if (levelTextures.get(i).matches("covib.+")) {//ionic with full circular base and vines
                Column coltu = new Column();
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 1,4,18,71,true,false,0,true,2, false,0, false,0);
            }
            if (levelTextures.get(i).matches("covio.+")) {//ionic with vines
                Column coltu = new Column();
            ...
            if (levelTextures.get(i).matches("cfftb.+")) {//tuscan with fire and full circular base and flag
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,18,71,true,true,0,true,1, false,0, false,0);
            }
            if (levelTextures.get(i).matches("cfftb.+")) {//tuscan with fire and full circular base and flag
                Column coltu = new Column();
            ...
            if (levelTextures.get(i).matches("cfftu.+")) {//tuscan with fire and flag
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 2,4,7,70,false,true,0,true,1, false,0, false,0);
            }
            if (levelTextures.get(i).matches("cffdb.+")) {//doric with fire and full circular base and flag
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 3,4,18,71,true,true,0,true,1, false,0, false,0);
            }
            ...
            if (levelTextures.get(i).matches("cffib.+")) {//ionic with fire and full circular base and flag
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 1,4,18,71,true,true,0,true,1, false,0, false,0);
            }
            if (levelTextures.get(i).matches("cffio.+")) {//ionic with fire and flag
                ...
                currentCell = init.cr.middleFloorTile;
                generateColumn(colExt2, strRoof, i,world, roomX, levelY, 1,4,7,70,false,true,0,true,1, false,0, false,0);
            }
            ...
            //WATER
                ...
                String width1 = String.valueOf(strRoof.charAt(0));
                String width2 = String.valueOf(strRoof.charAt(1));
                String widthStr = width1 + width2;
                int width = Integer.parseInt(widthStr);

                String height1 = String.valueOf(strRoof.charAt(2));
                String height2 = String.valueOf(strRoof.charAt(3));
            ...
            else if (levelTextures.get(i).matches("Wf3.+")) {
                ...
                for (int iW = 0; iW < width; iW++) {
                    for (int iH = 0; iH < height ; iH++) {
                        Water wf3 = new Water(world, ((roomX + i) * 16) + 16 * 16 + (iW * 16), levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 - (iH * 16), 2);
                        water.add(wf3);
                        if (!waterCreated) {
                            waterCreated = true;
            ...
            else if (levelTextures.get(i).matches("Wf4.+")) {
                ...
                for (int iW = 0; iW < width; iW++) {
                    for (int iH = 0; iH < height ; iH++) {
                        Water wf4 = new Water(world, ((roomX + i) * 16) + 16 * 16 + (iW * 16), levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 - (iH * 16), 2);
                        water.add(wf4);
                        if (!waterCreated) {
                            waterCreated = true;
            ...
            else if (levelTextures.get(i).matches("wstlt.+")) {
    ...
    if (startingRoom) {
        ...
        PLAYER_X = (doorUpperLeftXAsFloat * 10) + 20f - 0.5f;

        String doorUpperLeftY = doorUpperLeftXY[1].toString();
        float doorUpperLeftYAsFloat = Float.parseFloat(doorUpperLeftY);
        PLAYER_Y = doorUpperLeftYAsFloat * 16 - (3 * 20) + 3;
    ...
    public void generateColumn(int colExte, String colStr, int i, World world, float roomX, float levelY,
        ...
        if (colExte == 0) {
            ...
            if (fire) {
                Fire firecfl = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 + 4, false, 0f, 1, false, 0);
                firecfl.createFire(new Color(0.30f,0.12f,0,0.75f),60, null);
                fires.add(firecfl);
                lights.add(firecfl);

                Brazier newBrazier = new Brazier(world, ((roomX + i) * 16) + 16 * 16 + 0.5f, levelY * 16 + Gdx.graphics.getHeight() / 30 + 6f, 1);
                newBrazier.createBrazier();
                braziers.add(newBrazier);

            }
            if (shaderObject) {
                if (shaderObjectType == 1) {
                    Flag flag2 = new Flag(world, ((roomX + i) * 16) + 16 * 16 + 3.5f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16);
            ...
            coltu.addPiece(colTuTop);
            if (fire) {
                Fire firecfl = new Fire(world, rayHandler, ((roomX + i) * 16) + 16 * 16, levelY * 16 + Gdx.graphics.getHeight() / 30 + 4 + (colExte * 16), false, 0f, 1, false, 0);
                firecfl.createFire(new Color(0.30f,0.12f,0,0.75f),60, null);
                fires.add(firecfl);
                lights.add(firecfl);

                Brazier newBrazier = new Brazier(world, ((roomX + i) * 16) + 16 * 16 + 0.5f, levelY * 16 + Gdx.graphics.getHeight() / 30 + (colExte * 16) + 6f, 1);
                newBrazier.createBrazier();
                braziers.add(newBrazier);
            }
            if (shaderObject) {
                if (shaderObjectType == 1) {
                    Flag flag2 = new Flag(world, ((roomX + i) * 16) + 16 * 16 + 3.5f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + (colExte * 16));
                    flag2.createFlagHitbox(((roomX + i) * 16) + 16 * 16 + 3.5f,levelY * 16 + Gdx.graphics.getHeight() / 30 - 16 + (colExte * 16), world);
                    flags.add(flag2);
                } else {
