                ...
                for(int i=0;i<4;i++) {
                    ...
                    if (i == 0) {
                       ...
                       // }
                        ...
                        int rand = Random.randomInt(4,4);

                        int rand2 = Random.randomInt(4,4);
                    ...
                    if (i == 1) {
                        for (int iTop = 0; iTop<4; iTop++) {
                            if (iTop == 0) {
                                ...
                                if (rand2 == 2) {
                                    Torch torU = new Torch(rayHandler, world,  ((doorX + iTop) * 16) + 15*16 + 8,  ((doorY * 16 + Gdx.graphics.getHeight() / 30 - 16) - (i-1)*16) + 8,1);
                                    torches.add(torU);
                    ...
                    if (i == 4){
                        for (int iBottom = 0; iBottom<4; iBottom++) {
                            if (iBottom == 0) {
                                ...
                                if (rand2 == 2) {
                                    Torch torD = new Torch(rayHandler, world,  ((doorX + iBottom) * 16) + 15*16 + 8,  ((doorY * 16 + Gdx.graphics.getHeight() / 30 - 16) - (i-1)*16) + 8, 2);
                                    torches.add(torD);
