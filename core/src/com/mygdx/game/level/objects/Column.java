...
public class Column {
    ...
    public void createBrokenBaseHitbox(int size, boolean fullbase, float columnX, float columnY, World world) {
        BodyFactory bodyFactory = new BodyFactory();

        stemBody = bodyFactory.createBrokenBaseHitbox(world, columnX, columnY, size, fullbase);
        stemBody.setUserData("Stem");
